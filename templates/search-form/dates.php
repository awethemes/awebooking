	...
	<div class="searchbox__box-wrap">
		<div class="searchbox__box-line">
			...
			<div class="searchbox__box-input">
				<input type="text" data-bind="value: checkInFormatted()" class="searchbox__input searchbox__input--checkin input-transparent" placeholder="<?php echo esc_attr( $res_request['check_in'] ?: abrs_get_date_format() ); ?>" autocomplete="off" aria-haspopup="true">
...
<div class="searchbox__box searchbox__box--checkout">
	<div class="searchbox__box-wrap">
		<div class="searchbox__box-line">
			...
			<div class="searchbox__box-input">
				<input type="text" data-bind="value: checkOutFormatted()" class="searchbox__input searchbox__input--checkout input-transparent" placeholder="<?php echo esc_attr( $res_request['check_out'] ?: abrs_get_date_format() ); ?>" autocomplete="off" aria-haspopup="true">
