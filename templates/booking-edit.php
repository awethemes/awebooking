			...
			<tbody>
				<tr>
					...
					<?php
						...
						if ( $booking_request->get_infants() ) {
							printf( _nx( ' & %s infant', ' & %s infants', (int) $booking_request->get_infants(), 'infant(s) information', 'awebooking' ), number_format_i18n( (int) $booking_request->get_infants() ) ); // WPCS: xss ok.
						}
					?>
					</td>
