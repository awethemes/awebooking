<?php
/**
 * The template for displaying hotels.
 *
 * This template can be overridden by copying it to {yourtheme}/awebooking/archive-hotel.php.
 *
...
if ( have_posts() ) {
	...
	while ( have_posts() ) : the_post(); // @codingStandardsIgnoreLine
		abrs_get_template_part( 'template-parts/hotel/content', apply_filters( 'abrs_archive_hotel_layout', 'archive' ) );
	endwhile;
