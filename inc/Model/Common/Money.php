...
class Money implements Stringable {
	...
	protected function resolve_currency( $currency ) {
		...
		if ( empty( $currency ) ) {
			return awebooking()->make( 'currency' );
		}

		return awebooking( 'currencies' )->get( $currency );
	}

	/**
	 * Ensures that the two Money have the same currency.
	 *
	 * @param \AweBooking\Model\Common\Money $a The money A.
	 * @param \AweBooking\Model\Common\Money $b The money B.
	 *
