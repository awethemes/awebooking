...
class Email_Setting extends Abstract_Setting {
	...
	public function setup_fields() {
		$email_general = $this->add_section( 'email-general', [
			'title'    => esc_html__( 'Email Sender', 'awebooking' ),
			'priority' => 0,
		]);

		$admin_new_booking = $this->add_section( 'admin-new-booking', [
			'title'    => esc_html__( 'New Booking (Admin)', 'awebooking' ),
			'priority' => 10,
		]);

		$new_booking = $this->add_section( 'email-new-booking', [
			'title'    => esc_html__( 'New Booking', 'awebooking' ),
			'priority' => 20,
		]);

		$cancelled_booking = $this->add_section( 'email-cancelled-booking', [
			'title'    => esc_html__( 'Cancelled Booking', 'awebooking' ),
			'priority' => 30,
		]);

		$processing_booking = $this->add_section( 'email-processing-booking', [
			'title'    => esc_html__( 'Processing Booking', 'awebooking' ),
			'priority' => 40,
		]);

		$completed_booking = $this->add_section( 'email-completed-booking', [
