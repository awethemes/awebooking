...
class Booking_Processing extends Mailable {
	...
	public function dummy() {
		...
		// if ( $this->get_template( 'processing-booking' ) ) {
			$content = $this->get_template( 'processing-booking', apply_filters( 'awebooking/new_email_dummy_data', [
				'booking_id'           => 1,
	...
	public function get_content() {
		$content = awebooking_option( 'email_processing_content' );
