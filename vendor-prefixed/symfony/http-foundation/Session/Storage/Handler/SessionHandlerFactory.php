...
use AweBooking\Vendor\Doctrine\DBAL\DriverManager;
use AweBooking\Vendor\Symfony\Component\Cache\Adapter\AbstractAdapter;
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \AweBooking\Vendor\Predis\ClientInterface:
