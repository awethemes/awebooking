...
use AweBooking\Vendor\Symfony\Component\ErrorHandler\Exception\FlattenException;
...
class Notification
{
    private const LEVELS = [LogLevel::DEBUG => 100, LogLevel::INFO => 200, LogLevel::NOTICE => 250, LogLevel::WARNING => 300, LogLevel::ERROR => 400, LogLevel::CRITICAL => 500, LogLevel::ALERT => 550, LogLevel::EMERGENCY => 600];
