...
class DifferenceFormatter implements DifferenceFormatterInterface
{
     ...
     *
     * @var \AweBooking\Vendor\Cake\Chronos\Translator
     */
    protected $translate;
    /**
     * Constructor.
     *
     * @param \AweBooking\Vendor\Cake\Chronos\Translator|null $translate The text translator object.
     */
     ...
     *
     * @param \AweBooking\Vendor\Cake\Chronos\ChronosInterface $date The datetime to start with.
     * @param \AweBooking\Vendor\Cake\Chronos\ChronosInterface|null $other The datetime to compare against.
     * @param bool $absolute removes time difference modifiers ago, after, etc
     * @return string The difference between the two days in a human readable format
     * @see \AweBooking\Vendor\Cake\Chronos\ChronosInterface::diffForHumans
     */
