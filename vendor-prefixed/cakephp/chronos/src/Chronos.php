...
class Chronos extends DateTimeImmutable implements ChronosInterface
{
     ...
     *
     * @var \AweBooking\Vendor\Cake\Chronos\ChronosInterface|null
     */
     ...
     *
     * @return \AweBooking\Vendor\Cake\Chronos\MutableDateTime
     */
     ...
     * instance is created.
     *
     * @return \AweBooking\Vendor\Cake\Chronos\ChronosInterface|null The current instance used for testing
     */
    ...
    {
        $properties = ['hasFixedNow' => static::hasTestNow(), 'time' => $this->format('Y-m-d H:i:s.u'), 'timezone' => $this->getTimezone()->getName()];
        return $properties;
    }
}
