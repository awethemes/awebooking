...
class ChronosInterval extends DateInterval
{
     ...
     */
    public function __construct(?int $years = 1, ?int $months = null, ?int $weeks = null, ?int $days = null, ?int $hours = null, ?int $minutes = null, ?int $seconds = null, ?int $microseconds = null)
    {
     ...
     * @return static
     */
    public static function create(?int $years = 1, ?int $months = null, ?int $weeks = null, ?int $days = null, ?int $hours = null, ?int $minutes = null, ?int $seconds = null, ?int $microseconds = null) : self
    {
    ...
    public function __toString() : string
    {
        ...
        $s = $totalSecs;
        $date = \array_filter([static::PERIOD_YEARS => $y, static::PERIOD_MONTHS => $m, static::PERIOD_DAYS => $d]);
        $time = \array_filter([static::PERIOD_HOURS => $h, static::PERIOD_MINUTES => $i, static::PERIOD_SECONDS => $s]);
