...
use AweBooking\Vendor\Cake\Chronos\Chronos;
...
trait TestingAidTrait
{
     ...
     *
     * @see \AweBooking\Vendor\Cake\Chronos\Chronos::setTestNow()
     * @param \AweBooking\Vendor\Cake\Chronos\ChronosInterface|string|null $testNow The instance to use for all future instances.
     * @return void
     */
     ...
     *
     * @see \AweBooking\Vendor\Cake\Chronos\Chronos::getTestNow()
     * @return \AweBooking\Vendor\Cake\Chronos\ChronosInterface|null the current instance used for testing or null.
     */
     ...
     *
     * @see \AweBooking\Vendor\Cake\Chronos\Chronos::hasTestNow()
