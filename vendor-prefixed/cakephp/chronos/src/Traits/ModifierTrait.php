...
trait ModifierTrait
{
     ...
     * @var array
     */
    protected static $days = [ChronosInterface::MONDAY => 'Monday', ChronosInterface::TUESDAY => 'Tuesday', ChronosInterface::WEDNESDAY => 'Wednesday', ChronosInterface::THURSDAY => 'Thursday', ChronosInterface::FRIDAY => 'Friday', ChronosInterface::SATURDAY => 'Saturday', ChronosInterface::SUNDAY => 'Sunday'];
    /**
     * First day of week
     *
     * @var int
    ...
    {
        $y = $this->year - 1 - ($this->year - 1) % ChronosInterface::YEARS_PER_CENTURY + ChronosInterface::YEARS_PER_CENTURY;
