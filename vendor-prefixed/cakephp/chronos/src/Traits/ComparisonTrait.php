...
trait ComparisonTrait
{
     ...
     * @param \AweBooking\Vendor\Cake\Chronos\ChronosInterface $dt1 The instance to compare with.
     * @param \AweBooking\Vendor\Cake\Chronos\ChronosInterface $dt2 The instance to compare with.
     * @return \AweBooking\Vendor\Cake\Chronos\ChronosInterface
     */
    ...
    {
        return \in_array($this->dayOfWeek, self::$weekendDays, \true);
    }
    /**
     ...
     *
     * @param \AweBooking\Vendor\Cake\Chronos\ChronosInterface|null $dt The instance to compare with or null to use current day.
     * @return bool
     */
