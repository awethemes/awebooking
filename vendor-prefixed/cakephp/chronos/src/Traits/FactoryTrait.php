...
trait FactoryTrait
{
     ...
     * @return static
     */
    public static function create(?int $year = null, ?int $month = null, ?int $day = null, ?int $hour = null, ?int $minute = null, ?int $second = null, ?int $microsecond = null, $tz = null) : ChronosInterface
    {
        $now = static::now();
        ...
        $instance = static::createFromFormat('Y-m-d H:i:s.u', \sprintf('%s-%s-%s %s:%02s:%02s.%06s', 0, $month, $day, $hour, $minute, $second, $microsecond), $tz);
     ...
     * @return static
     */
    public static function createFromTime(?int $hour = null, ?int $minute = null, ?int $second = null, ?int $microsecond = null, $tz = null) : ChronosInterface
    {
