...
class Stringable
{
    ...
    {
        return \AweBooking\Vendor\collect(\explode($delimiter, $this->value, $limit));
    }
    /**
    ...
    public function split($pattern, $limit = -1, $flags = 0)
    {
        ...
        return !empty($segments) ? \AweBooking\Vendor\collect($segments) : \AweBooking\Vendor\collect();
    }
    /**
    ...
    public function matchAll($pattern)
    {
        ...
        return \AweBooking\Vendor\collect($matches[1] ?? $matches[0]);
    }
    /**
