...
use ArrayIterator;
use Closure;
use AweBooking\Vendor\Illuminate\Support\Traits\EnumeratesValues;
...
class LazyCollection implements Enumerable
{
    ...
    public function first(callable $callback = null, $default = null)
    {
        ...
        if (\is_null($callback)) {
            if (!$iterator->valid()) {
                return \AweBooking\Vendor\value($default);
            }
    ...
    public function last(callable $callback = null, $default = null)
    {
        ...
        return $needle === $placeholder ? \AweBooking\Vendor\value($default) : $needle;
    }
    /**
    ...
    public function pluck($value, $key = null)
    {
        return new static(function () use($value, $key) {
            ...
            foreach ($this as $item) {
                $itemValue = \AweBooking\Vendor\data_get($item, $value);
                if (\is_null($key)) {
                    (yield $itemValue);
                } else {
                    $itemKey = \AweBooking\Vendor\data_get($item, $key);
