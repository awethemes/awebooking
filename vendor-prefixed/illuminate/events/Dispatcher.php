...
namespace AweBooking\Vendor\Illuminate\Events;

use Exception;
use AweBooking\Vendor\Illuminate\Container\Container;
use AweBooking\Vendor\Illuminate\Contracts\Broadcasting\Factory as BroadcastFactory;
use AweBooking\Vendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
use AweBooking\Vendor\Illuminate\Contracts\Container\Container as ContainerContract;
use AweBooking\Vendor\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use AweBooking\Vendor\Illuminate\Contracts\Queue\ShouldQueue;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @var \AweBooking\Vendor\Illuminate\Contracts\Container\Container
     */
    protected $container;
    /**
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Contracts\Container\Container|null  $container
     * @return void
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
    ...
    {
        return \AweBooking\Vendor\tap($job, function ($job) use($listener) {
