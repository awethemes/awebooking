...
namespace AweBooking\Vendor\Illuminate\Database\Concerns;
...
trait BuildsQueries
{
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|object|static|null
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Support\Collection  $items
     * @param  int  $total
     * @param  int  $perPage
     * @param  int  $currentPage
     * @param  array  $options
     * @return \AweBooking\Vendor\Illuminate\Pagination\LengthAwarePaginator
     */
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \AweBooking\Vendor\Illuminate\Pagination\Paginator
     */
