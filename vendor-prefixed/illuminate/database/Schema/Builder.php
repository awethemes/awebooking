...
class Builder
{
    ...
    {
        $this->build(\AweBooking\Vendor\tap($this->createBlueprint($table), function ($blueprint) use($callback) {
            $blueprint->create();
            $callback($blueprint);
        }));
    }
    ...
    {
        $this->build(\AweBooking\Vendor\tap($this->createBlueprint($table), function ($blueprint) {
            $blueprint->drop();
        }));
    }
    /**
    ...
    {
        $this->build(\AweBooking\Vendor\tap($this->createBlueprint($from), function ($blueprint) use($to) {
            $blueprint->rename($to);
        }));
    }
    /**
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Schema\Blueprint
     */
    ...
    public function registerCustomDoctrineType($class, $name, $type)
    {
        ...
        if (!Type::hasType($name)) {
            ...
            $this->connection->getDoctrineSchemaManager()->getDatabasePlatform()->registerDoctrineTypeMapping($type, $name);
        }
    }
    /**
