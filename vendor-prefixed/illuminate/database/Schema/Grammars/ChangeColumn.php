...
use AweBooking\Vendor\Doctrine\DBAL\Schema\Comparator;
use AweBooking\Vendor\Doctrine\DBAL\Schema\Table;
use AweBooking\Vendor\Doctrine\DBAL\Types\Type;
...
class ChangeColumn
{
     ...
     *
     * @param  \Doctrine\DBAL\Schema\Table  $table
     * @param \AweBooking\Vendor\Illuminate\Support\Fluent  $fluent
    ...
    {
        return \in_array($type, ['bigInteger', 'binary', 'boolean', 'date', 'decimal', 'double', 'float', 'integer', 'json', 'mediumInteger', 'smallInteger', 'time', 'tinyInteger']);
    }
    /**
