...
namespace AweBooking\Vendor\Illuminate\Database\Schema\Grammars;

use AweBooking\Vendor\Doctrine\DBAL\Schema\AbstractSchemaManager as SchemaManager;
use AweBooking\Vendor\Doctrine\DBAL\Schema\TableDiff;
...
abstract class Grammar extends BaseGrammar
{
     ...
     * @param \AweBooking\Vendor\Illuminate\Support\Fluent  $command
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Support\Fluent  $column
     * @return string
     */
     ...
     * @param \AweBooking\Vendor\Illuminate\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \AweBooking\Vendor\Illuminate\Support\Fluent|null
     */
    ...
    public function getDoctrineTableDiff(Blueprint $blueprint, SchemaManager $schema)
    {
        ...
        return \AweBooking\Vendor\tap(new TableDiff($table), function ($tableDiff) use($schema, $table) {
