...
use Closure;
use AweBooking\Vendor\Illuminate\Database\Connection;
use AweBooking\Vendor\Illuminate\Database\Query\Expression;
use AweBooking\Vendor\Illuminate\Database\Schema\Grammars\Grammar;
use AweBooking\Vendor\Illuminate\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \AweBooking\Vendor\Illuminate\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
    /**
     * The commands that should be run for the table.
     *
     * @var \AweBooking\Vendor\Illuminate\Support\Fluent[]
     */
    protected $commands = [];
    /**
    ...
    {
        return \AweBooking\Vendor\collect($this->commands)->filter(function ($command) use($names) {
    ...
    {
        return \AweBooking\Vendor\collect($this->commands)->contains(function ($command) {
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \AweBooking\Vendor\Illuminate\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \AweBooking\Vendor\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \AweBooking\Vendor\Illuminate\Database\Schema\ForeignIdColumnDefinition
     */
    public function foreignId($column)
    {
        $this->columns[] = $column = new ForeignIdColumnDefinition($this, ['type' => 'bigInteger', 'name' => $column, 'autoIncrement' => \false, 'unsigned' => \true]);
        return $column;
    }
    /**
