...
use AweBooking\Vendor\Illuminate\Database\Eloquent\ModelNotFoundException;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder|null  $query
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \AweBooking\Vendor\Illuminate\Support\Collection|\AweBooking\Vendor\Illuminate\Database\Eloquent\Model
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|\AweBooking\Vendor\Illuminate\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|\AweBooking\Vendor\Illuminate\Database\Eloquent\Collection
     *
    ...
    protected function aliasedPivotColumns()
    {
        ...
        return \AweBooking\Vendor\collect(\array_merge($defaults, $this->pivotColumns))->map(function ($column) {
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return \AweBooking\Vendor\tap($this->query->paginate($perPage, $columns, $pageName, $page), function ($paginator) {
    ...
    {
        $this->query->addSelect($this->shouldSelect($columns));
        return \AweBooking\Vendor\tap($this->query->simplePaginate($perPage, $columns, $pageName, $page), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    /**
    ...
    {
        return Str::camel(Str::pluralStudly(\AweBooking\Vendor\class_basename($this->getParent())));
    }
    /**
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Support\Collection|array  $models
     * @param  array  $pivotAttributes
     * @return array
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder  $query
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder  $parentQuery
