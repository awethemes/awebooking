...
/**
 * @mixin \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder
 */
abstract class Relation
{
     ...
     *
     * @var \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder
     */
    protected $query;
    /**
    ...
    {
        return \AweBooking\Vendor\collect($models)->map(function ($value) use($key) {
    ...
    {
        return $model->getKeyName() === \AweBooking\Vendor\last(\explode('.', $key)) && \in_array($model->getKeyType(), ['int', 'integer']) ? 'whereIntegerInRaw' : 'whereIn';
    }
    /**
