...
use ArrayAccess;
use Exception;
use AweBooking\Vendor\Illuminate\Contracts\Queue\QueueableCollection;
use AweBooking\Vendor\Illuminate\Contracts\Queue\QueueableEntity;
use AweBooking\Vendor\Illuminate\Contracts\Routing\UrlRoutable;
use AweBooking\Vendor\Illuminate\Contracts\Support\Arrayable;
use AweBooking\Vendor\Illuminate\Contracts\Support\Jsonable;
use AweBooking\Vendor\Illuminate\Database\ConnectionResolverInterface as Resolver;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\Concerns\AsPivot;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\Pivot;
use AweBooking\Vendor\Illuminate\Support\Arr;
use AweBooking\Vendor\Illuminate\Support\Collection as BaseCollection;
...
abstract class Model implements Arrayable, ArrayAccess, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     *
     * @var \AweBooking\Vendor\Illuminate\Database\ConnectionResolverInterface
     */
    protected static $resolver;
    /**
     * The event dispatcher instance.
     *
     * @var \AweBooking\Vendor\Illuminate\Contracts\Events\Dispatcher
     */
    ...
    protected static function bootTraits()
    {
        ...
        foreach (\AweBooking\Vendor\class_uses_recursive($class) as $trait) {
            $method = 'boot' . \AweBooking\Vendor\class_basename($trait);
            if (\method_exists($class, $method) && !\in_array($method, $booted)) {
                \forward_static_call([$class, $method]);
                $booted[] = $method;
            }
            if (\method_exists($class, $method = 'initialize' . \AweBooking\Vendor\class_basename($trait))) {
     ...
     * @return $this
     *
     * @throws \AweBooking\Vendor\Illuminate\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder  $query
     * @return bool
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder|static
     */
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \AweBooking\Vendor\Illuminate\Database\Eloquent\JsonEncodingException
     */
    ...
    public function refresh()
    {
        ...
        $this->load(\AweBooking\Vendor\collect($this->relations)->reject(function ($relation) {
            return $relation instanceof Pivot || \is_object($relation) && \in_array(AsPivot::class, \AweBooking\Vendor\class_uses_recursive($relation), \true);
        })->keys()->all());
        $this->syncOriginal();
        return $this;
    }
    ...
    public function replicate(array $except = null)
    {
        ...
        return \AweBooking\Vendor\tap(new static(), function ($instance) use($attributes) {
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Database\Connection
     */
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
    ...
    {
        return $this->table ?? Str::snake(Str::pluralStudly(\AweBooking\Vendor\class_basename($this)));
    }
    /**
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|null
     */
    ...
    {
        return Str::snake(\AweBooking\Vendor\class_basename($this)) . '_' . $this->getKeyName();
    }
    /**
