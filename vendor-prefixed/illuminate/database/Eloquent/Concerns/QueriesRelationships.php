...
trait QueriesRelationships
{
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\Relation|string  $relation
        ...
        return $this->where(function ($query) use($relation, $callback, $operator, $count, $types) {
            foreach ($types as $type) {
                $query->orWhere(function ($query) use($relation, $callback, $operator, $count, $type) {
                    ...
                    $query->where($this->query->from . '.' . $relation->getMorphType(), '=', (new $type())->getMorphClass())->whereHas($belongsTo, $callback, $operator, $count);
                });
            }
        }, null, null, $boolean);
    }
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\MorphTo  $relation
     * @param  string  $type
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder  $hasQuery
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder|static
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder  $from
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder|static
     */
