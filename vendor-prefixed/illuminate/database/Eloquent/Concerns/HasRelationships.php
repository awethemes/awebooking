...
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\BelongsTo;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasMany;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasOne;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\MorphMany;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\MorphOne;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\MorphTo;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasOne
     */
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasOneThrough
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder  $query
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Model  $farParent
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Model  $throughParent
     ...
     * @param  string|null  $localKey
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\BelongsTo
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Builder  $query
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Model  $child
     * @param  string  $foreignKey
    ...
    public function morphTo($name = null, $type = null, $id = null, $ownerKey = null)
    {
        ...
        return \is_null($class = $this->{$type}) || $class === '' ? $this->morphEagerTo($name, $type, $id, $ownerKey) : $this->morphInstanceTo($class, $name, $type, $id, $ownerKey);
    }
    /**
     * Define a polymorphic, inverse one-to-one or many relationship.
     *
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasMany
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string|null  $relation
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string|null  $relatedKey
     * @param  bool  $inverse
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\MorphToMany
     */
     ...
     *
     * @param  string  $related
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|null  $instance
     * @return string
     */
    public function joiningTable($related, $instance = null)
    {
        ...
        $segments = [$instance ? $instance->joiningTableSegment() : Str::snake(\AweBooking\Vendor\class_basename($related)), $this->joiningTableSegment()];
    ...
    {
        return Str::snake(\AweBooking\Vendor\class_basename($this));
    }
    /**
    ...
    {
        return \AweBooking\Vendor\tap(new $class(), function ($instance) {
