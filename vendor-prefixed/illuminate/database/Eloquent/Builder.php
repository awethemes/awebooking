...
use AweBooking\Vendor\Illuminate\Database\Query\Builder as QueryBuilder;
 ...
 *
 * @mixin \AweBooking\Vendor\Illuminate\Database\Query\Builder
 */
class Builder
{
     ...
     *
     * @var \AweBooking\Vendor\Illuminate\Database\Query\Builder
     */
    protected $query;
    /**
     * The model being queried.
     *
     * @var \AweBooking\Vendor\Illuminate\Database\Eloquent\Model
     */
    protected $model;
    /**
     ...
     * @var array
     */
    protected $passthru = ['insert', 'insertOrIgnore', 'insertGetId', 'insertUsing', 'getBindings', 'toSql', 'dump', 'dd', 'exists', 'doesntExist', 'count', 'min', 'max', 'avg', 'average', 'sum', 'getConnection', 'raw', 'getGrammar'];
    /**
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|static
     */
     ...
     * @param \AweBooking\Vendor\Illuminate\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Closure|string|array|\AweBooking\Vendor\Illuminate\Database\Query\Expression  $column
     ...
     *
     * @param  \Closure|array|string|\AweBooking\Vendor\Illuminate\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\AweBooking\Vendor\Illuminate\Database\Query\Expression  $column
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|\AweBooking\Vendor\Illuminate\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Contracts\Support\Arrayable|array  $ids
     * @param  array  $columns
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|\AweBooking\Vendor\Illuminate\Database\Eloquent\Collection|static|static[]
     *
     * @throws \AweBooking\Vendor\Illuminate\Database\Eloquent\ModelNotFoundException
     */
    ...
    public function firstOrCreate(array $attributes, array $values = [])
    {
        ...
        return \AweBooking\Vendor\tap($this->newModelInstance($attributes + $values), function ($instance) {
            $instance->save();
        });
    }
    /**
    ...
    {
        return \AweBooking\Vendor\tap($this->firstOrNew($attributes), function ($instance) use($values) {
     ...
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  string  $name
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\Model|$this
     */
    public function create(array $attributes = [])
    {
        return \AweBooking\Vendor\tap($this->newModelInstance($attributes), function ($instance) {
            $instance->save();
        });
    }
    /**
    ...
    {
        $whereBooleans = \AweBooking\Vendor\collect($whereSlice)->pluck('boolean');
