...
use AweBooking\Vendor\Symfony\Component\Finder\Finder;
class Factory implements ArrayAccess
{
    ...
    {
        return \array_merge(\call_user_func($this->definitions[$class], $this->faker), $attributes);
    }
    /**
     * Create a builder for the given model.
     *
     * @param  string  $class
     * @return \AweBooking\Vendor\Illuminate\Database\Eloquent\FactoryBuilder
     */
    public function of($class)
    {
        return new FactoryBuilder($class, $this->definitions, $this->states, $this->afterMaking, $this->afterCreating, $this->faker);
    }
    /**
