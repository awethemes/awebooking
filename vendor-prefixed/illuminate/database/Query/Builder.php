...
namespace AweBooking\Vendor\Illuminate\Database\Query;

use Closure;
use DateTimeInterface;
use AweBooking\Vendor\Illuminate\Contracts\Support\Arrayable;
use AweBooking\Vendor\Illuminate\Database\Concerns\BuildsQueries;
use AweBooking\Vendor\Illuminate\Database\ConnectionInterface;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use AweBooking\Vendor\Illuminate\Database\Eloquent\Relations\Relation;
use AweBooking\Vendor\Illuminate\Database\Query\Grammars\Grammar;
use AweBooking\Vendor\Illuminate\Database\Query\Processors\Processor;
...
use AweBooking\Vendor\Illuminate\Support\LazyCollection;
use AweBooking\Vendor\Illuminate\Support\Str;
use AweBooking\Vendor\Illuminate\Support\Traits\ForwardsCalls;
use AweBooking\Vendor\Illuminate\Support\Traits\Macroable;
...
class Builder
{
     ...
     *
     * @var \AweBooking\Vendor\Illuminate\Database\ConnectionInterface
     */
    public $connection;
    /**
     * The database query grammar instance.
     *
     * @var \AweBooking\Vendor\Illuminate\Database\Query\Grammars\Grammar
     */
    public $grammar;
    /**
     * The database query post processor instance.
     *
     * @var \AweBooking\Vendor\Illuminate\Database\Query\Processors\Processor
     */
    public $processor;
    /**
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\ConnectionInterface  $connection
     * @param \AweBooking\Vendor\Illuminate\Database\Query\Grammars\Grammar|null  $grammar
     * @param \AweBooking\Vendor\Illuminate\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\AweBooking\Vendor\Illuminate\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Closure|\AweBooking\Vendor\Illuminate\Database\Query\Builder|string  $table
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \AweBooking\Vendor\Illuminate\Database\Query\JoinClause
     */
    ...
    {
        return !\in_array(\strtolower($operator), $this->operators, \true) && !\in_array(\strtolower($operator), $this->grammar->getOperators(), \true);
    }
    /**
     ...
     *
     * @param  string  $column
     * @param \AweBooking\Vendor\Illuminate\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Database\Query\Builder
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\AweBooking\Vendor\Illuminate\Database\Query\Builder|\AweBooking\Vendor\Illuminate\Database\Query\Expression|string  $column
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return \AweBooking\Vendor\Illuminate\Support\Collection
     */
    public function get($columns = ['*'])
    {
        return \AweBooking\Vendor\collect($this->onceWithColumns(Arr::wrap($columns), function () {
    ...
    public function paginate($perPage = 15, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        $results = $total ? $this->forPage($page, $perPage)->get($columns) : \AweBooking\Vendor\collect();
    ...
    public function pluck($column, $key = null)
    {
        ...
        if (empty($queryResult)) {
            return \AweBooking\Vendor\collect();
        }
    ...
    protected function stripTableForPluck($column)
    {
        ...
        return \AweBooking\Vendor\last(\preg_split('~' . $separator . '~i', $column));
    }
    /**
    ...
    protected function pluckFromObjectColumn($queryResult, $column, $key)
    {
        ...
        return \AweBooking\Vendor\collect($results);
    }
    /**
    ...
    {
        $results = $this->cloneWithout($this->unions ? [] : ['columns'])->cloneWithoutBindings($this->unions ? [] : ['select'])->setAggregate($function, $columns)->get($columns);
        if (!$results->isEmpty()) {
     ...
     *
     * @param  mixed  $value
     * @return \AweBooking\Vendor\Illuminate\Database\Query\Expression
     */
    ...
    {
        return \is_array($value) ? \AweBooking\Vendor\head(Arr::flatten($value)) : $value;
    }
    /**
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Database\ConnectionInterface
     */
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Database\Query\Grammars\Grammar
     */
    ...
    {
        return \AweBooking\Vendor\tap(clone $this, function ($clone) use($properties) {
    ...
    {
        return \AweBooking\Vendor\tap(clone $this, function ($clone) use($except) {
