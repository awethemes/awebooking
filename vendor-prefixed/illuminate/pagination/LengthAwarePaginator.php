...
use ArrayAccess;
use Countable;
use AweBooking\Vendor\Illuminate\Contracts\Pagination\LengthAwarePaginator as LengthAwarePaginatorContract;
...
class LengthAwarePaginator extends AbstractPaginator implements Arrayable, ArrayAccess, Countable, IteratorAggregate, Jsonable, JsonSerializable, LengthAwarePaginatorContract
{
     ...
     * @param  array  $data
     * @return \AweBooking\Vendor\Illuminate\Contracts\Support\Htmlable
     */
