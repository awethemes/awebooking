...
namespace AweBooking\Vendor\Illuminate\Pagination;
...
/**
 * @mixin \AweBooking\Vendor\Illuminate\Support\Collection
 */
abstract class AbstractPaginator implements Htmlable
{
     ...
     *
     * @var \AweBooking\Vendor\Illuminate\Support\Collection
     */
    protected $items;
    /**
    ...
    {
        return \AweBooking\Vendor\collect(\range($start, $end))->mapWithKeys(function ($page) {
     ...
     *
     * @return \AweBooking\Vendor\Illuminate\Contracts\View\Factory
     */
     ...
     *
     * @param \AweBooking\Vendor\Illuminate\Support\Collection  $collection
     * @return $this
     */
