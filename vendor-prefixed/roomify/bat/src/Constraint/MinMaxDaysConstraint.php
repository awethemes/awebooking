 ...
 */
namespace AweBooking\Vendor\Roomify\Bat\Constraint;

use AweBooking\Vendor\Roomify\Bat\Calendar\CalendarResponse;
...
class MinMaxDaysConstraint extends Constraint
{
    ...
    public function toString()
    {
        ...
        $args = array('@minimum_stay' => $minimum_stay, '@maximum_stay' => $maximum_stay, '@day_of_the_week' => $day_of_the_week);
