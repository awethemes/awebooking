 ...
 * Class AbstractEvent
 */
namespace AweBooking\Vendor\Roomify\Bat\Event;

use AweBooking\Vendor\Roomify\Bat\Event\EventInterface;
use AweBooking\Vendor\Roomify\Bat\Store\Store;
use AweBooking\Vendor\Roomify\Bat\EventFormatter\EventFormatter;
...
abstract class AbstractEvent implements EventInterface
{
    ...
    {
        $overlaps = \FALSE;
        if ($this->dateIsEarlier($start) && ($this->dateIsInRange($end) || $this->dateIsLater($end))) {
            $overlaps = \TRUE;
        } elseif ($this->dateIsInRange($start) && ($this->dateIsInRange($end) || $this->dateIsLater($end))) {
            $overlaps = \TRUE;
        }
        return $overlaps;
    }
