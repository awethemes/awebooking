...
namespace AweBooking\Tests\Componment\View;
...
class ViewTest extends TestCase {
	...
	public function testRenderProperlyRendersView() {
		...
		$view->getEngine()->shouldReceive( 'get' )->once()->with( 'path',
			[ 'foo' => 'bar', 'shared' => 'foo' ] )->andReturn( 'contents' );
	...
	public function testSectionsAreNotFlushedWhenNotDoneRendering() {
		...
		$view->getEngine()->shouldReceive( 'get' )->twice()->with( 'path',
			[ 'foo' => 'bar', 'shared' => 'foo' ] )->andReturn( 'contents' );
