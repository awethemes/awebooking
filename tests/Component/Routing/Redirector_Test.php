...
class Component_Routing_Redirector_Test extends WP_UnitTestCase {
	...
	public function testRedirectAdminRoute() {
		...
		$this->assertEquals('http://' . WP_TESTS_DOMAIN . '/wp-admin/admin.php?awebooking=/path/to&with=args', $response->getTargetUrl());
	}
}
