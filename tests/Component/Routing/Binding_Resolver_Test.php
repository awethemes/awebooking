...
class Component_Routing_Binding_Resolver_Test extends WP_UnitTestCase {
	public function setUp() {
		parent::setUp();

		$this->binding = new Binding_Resolver( Plugin::getInstance() );
	}
	...
	/**
	 * @expectedException AweBooking\Component\Http\Exceptions\ModelNotFoundException
	 */
