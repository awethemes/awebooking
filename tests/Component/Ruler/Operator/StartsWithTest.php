...
use Ruler\Context;
use Ruler\Variable;
use AweBooking\Component\Ruler\Operator\Starts_With;
use AweBooking\Component\Ruler\Operator\Not_Starts_With;

class StartsWithTest extends \WP_UnitTestCase {

	public function testInterface() {
		$varA = new Variable( 'a', 'foo bar baz' );
		$varB = new Variable( 'b', 'foo' );

		$op = new Starts_With( $varA, $varB );
	 ...
	 * @dataProvider startsWithData
	 */
	public function testNotStartsWith( $a, $b, $result ) {
		$varA    = new Variable( 'a', $a );
		$varB    = new Variable( 'b', $b );
		$context = new Context();

		$op = new Not_Starts_With( $varA, $varB );
