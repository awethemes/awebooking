...
class AweBooking_Test extends WP_UnitTestCase {
	...
	public function test_class_instances() {
		...
		$this->assertInstanceOf( 'AweBooking\\BAT\\Store', $this->awebooking['store.booking'] );
		$this->assertInstanceOf( 'AweBooking\\BAT\\Store', $this->awebooking['store.pricing'] );
		$this->assertInstanceOf( 'AweBooking\\BAT\\Store', $this->awebooking['store.availability'] );

		$this->assertInstanceOf( 'AweBooking\\Interfaces\\Concierge', $this->awebooking['concierge'] );
