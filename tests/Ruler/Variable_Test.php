...
use Ruler\Context;
use AweBooking\Ruler\Variable;
use AweBooking\Ruler\Variable_Property;

class Ruler_Variable_Test extends \WP_UnitTestCase {
	...
	public function testDynamicCallOpeators() {
		...
		// Compare operators.
		$this->assertInstanceOf('AweBooking\Ruler\Operator\Equal', $varA->equal(0));
		...
		$this->assertInstanceOf('AweBooking\Ruler\Operator\Not_Equal', $varA->not_equal(0));
		...
		$this->assertInstanceOf('AweBooking\Ruler\Operator\Greater_Than', $varA->greater_than(0));
		$this->assertTrue($varA->greater_than(0)->evaluate($context));
		$this->assertFalse($varA->greater_than(2)->evaluate($context));

		$this->assertInstanceOf('AweBooking\Ruler\Operator\Greater_Than_Or_Equal', $varA->greater_than_or_equal(0));
		...
		$this->assertInstanceOf('AweBooking\Ruler\Operator\Less_Than', $varA->less_than(0));
		$this->assertTrue($varA->less_than(2)->evaluate($context));
		$this->assertFalse($varA->less_than(0)->evaluate($context));

		$this->assertInstanceOf('AweBooking\Ruler\Operator\Less_Than_Or_Equal', $varA->less_than_or_equal(0));
