...
class Calendar_Store_DB_Store_Test extends WP_UnitTestCase {
	...
	public function testInstance() {
		...
		$provider = new DB_Provider( [ $resource ], 'awebooking_booking', 'room_id' );
		...
		$this->assertInstanceOf( BATStore::class, $provider->get_store());
	}
	...
	public function testGetEvents() {
		...
		$this->assertSame( '2017-11-30 00:00:00 ~ 2017-12-15 00:00:00', $this->format_event_date($events[1]) );
	...
	public function testGetEmptyResource() {
		$provider = new DB_Provider( [], 'awebooking_booking', 'room_id' );
	...
	public function testStoreEvent() {
		...
		$provider  = new DB_Provider( [ $resource, $resource2 ], 'awebooking_booking', 'room_id' );
	...
	/**
	 * @expectedException AweBooking\Calendar\Exceptions\UntrustedResourceException
	 */
