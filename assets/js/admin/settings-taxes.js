  ...
  (function ($, data, wp, ajaxurl) {
    $(function () {
      ...
      var rowTemplate = wp.template('wc-tax-table-row'),
        ...
        changes: {},
        setRateAttribute: function setRateAttribute(rateID, attribute, value) {
        ...
        logChanges: function logChanges(changedRows) {
        ...
        getFilteredRates: function getFilteredRates() {
        ...
        onAddNewRow: function onAddNewRow(event) {
          ...
          if ($current.length) {
            ...
            newRow.tax_rate_order = 1 + _.max(_.pluck(rates, 'tax_rate_order'), function (val) {
        ...
        onSearchField: function onSearchField(event) {
        ...
        setUnloadConfirmation: function setUnloadConfirmation() {
          this.needsUnloadConfirm = true;
          $save_button.prop('disabled', false);
        },
        clearUnloadConfirmation: function clearUnloadConfirmation() {
          this.needsUnloadConfirm = false;
          $save_button.prop('disabled', true);
        },
        unloadConfirmation: function unloadConfirmation(event) {
        ...
        updateModelOnChange: function updateModelOnChange(event) {
        ...
        sanitizePage: function sanitizePage(page_num) {
...
//# sourceMappingURL=settings-taxes.js.map
